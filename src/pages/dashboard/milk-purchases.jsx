...
const Add = React.lazy(() => import('../../page-sections/purchases/add'));
const Edit = React.lazy(() => import('../../page-sections/purchases/edit'));
            ...
            <Card>
                <CardHeader variant="gradient" color="blue" className="mb-4 p-3">
                    <div className="flex flex-row justify-between">
                        ...
                        <Button onClick={event => {event.preventDefault(); setIsAddOpen(true)}} className="inline-flex" variant="outlined" color="white" size="sm">
                            <PlusIcon className="w-4 h-4 text-inherit mr-1"/>ADD</Button>
                ...
                <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
                    <table className="w-full min-w-[640px] table-auto">
                        <thead>
                        <tr>
                            {["Sr.No.", "Customer Name",  "Milk Type", "Total Lit.", "Amount", "Is Paid","Created At", "Action"].map((el) => (
                                <th
                                    key={el}
                        ...
                        <tbody>
                        {apiData.map(
                            ({ id, customername, milk_type, lit, amount, date_created, is_paid}, key) => {
